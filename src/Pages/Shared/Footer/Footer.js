            ...
            <footer className="pt-4 shadow-lg bg-dark">
                <div className="container py-4 mx-auto row align-items-center justify-content-between">
                    <div className="col-lg-5 col-12">
                        <p className="text-white fw-bolder fs-4">Hospital Management System</p>
                        <small className="text-secondary d-block">Hospital Management System or HMS Software is mainly a system that can help to maintain any hospital activities properly and easily. </small>
